...
import { selectCartItems, selectCartState, selectTotalAmount, selectTotalQTY, setClearCartItem, setCloseCart, setGetTotals } from '../app/CartSlice.js';
        ...
        {cartItems.length === 0 ? <CartEmpty onCartToggle = {onCartToggle}/> : <div>
            ...
            <div className='fixed bottom-0 bg-white w-full px-5 py-2 grid items-center'>
              ...
              <div className='grid items-center gap-2 '>
                <p className='text-sm font-medium text-center'>Taxes and Shipping will be calculated at Shipping</p>
                <button type='button' className='bg-theme-cart text-white'>Check Out</button>
              </div>
            </div>
